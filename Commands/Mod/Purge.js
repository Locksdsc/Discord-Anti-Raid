module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        message.channel.bulkDelete(deleteAmount, true)
            .then(deleted => message.channel.send(`I deleted \`${deleted.size}\` messages.`)).then(m => {setTimeout(() => {m.delete().catch()}, 2000)})
            .catch(err => message.reply(`Something went wrong...

:no_entry: Because of Discord limitations I can't delete messages past 2 weeks.
